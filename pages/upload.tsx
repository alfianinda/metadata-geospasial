        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div
                className={`border-2 border-dashed rounded-lg p-6 transition-all duration-300 bg-gray-50 border-gray-300 ${
                  dragActive
                    ? 'border-indigo-500 bg-gray-50 shadow-lg'
                    : 'border-gray-300 hover:border-indigo-400 hover:shadow-md hover:bg-gray-50'
                }`}
              ...
              >
                <div className="text-center">
                  ...
                  <div className="mt-4">
                    <label
                      htmlFor="file-upload"
                      className="relative cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md font-medium transition-colors duration-200 shadow-sm hover:shadow-md focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2"
                    >
                  ...
                  <p className="mt-3 text-xs text-gray-500">
                    {dragActive ? 'Lepaskan file di sini' : 'atau seret dan jatuhkan file ke area ini'}
                  </p>
                  <div className="p-4 bg-gray-50">
                    <h4 className="text-xs font-semibold text-gray-600 mb-2 text-center">Format yang Didukung:</h4>
                    <div className="space-y-1 text-xs text-center">
                      <div className="justify-center space-x-2">
                        <span className="font-medium text-green-600">• GeoJSON</span>
                        <span className="text-gray-600">- File tunggal (.geojson, .json)</span>
                      </div>
                      <div className="justify-center space-x-2">
                        <span className="font-medium text-green-600">• Shapefile</span>
                      ...
                      <div className="justify-center space-x-2">
                        ...
                        <span className="text-gray-600">- Maksimal ukuran per file</span>
                      </div>
                    </div>
                    <div className="p-1">
                      <div className="flex items-start justify-center space-x-2">
                        ...
                        <p className="text-xs text-red-500 text-center">
                          <strong>Penting:</strong> Jangan upload file pendukung Shapefile (.prj, .cpg, .sbn, .sbx) tanpa file utama (.shp, .shx, .dbf)
                        </p>
                      </div>
                    </div>
                  </div>
